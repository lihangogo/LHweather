...
package com.lihangogo.lhweather.util.citypicker1.widget.wheel;
...
import com.lihangogo.lhweather.util.citypicker1.widget.wheel.adapters.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    private void drawShadows(Canvas canvas) {
        ...
        Log.d("LhWeather.wheel", "getItemHeight(): " + getItemHeight());
        Log.d("LhWeather.wheel", "height: " + height);
        Log.d("LhWeather.wheel", "getWidth: " + getWidth());
        Log.d("LhWeather.wheel", "getHeight():" + getHeight());
        Log.d("LhWeather.wheel", "visibleItems:" + visibleItems);
    }
