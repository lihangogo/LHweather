...
public class QueryWeatherResult implements Serializable{
	...
	public QueryWeatherResult(List<AlarmsIndex> alarms,CityBasicInfo basic, AirQualityIndex aqi, 
			Suggestion suggestion,CurrentTimeWeather now, List<WeatherForecast> daily_forecast, 
			List<HourlyForecast> hourly_forecast,String status) {
		super();
		this.alarms=alarms;
		this.basic = basic;
		this.aqi = aqi;
	...
	public List<AlarmsIndex> getAlarms() {
		return alarms;
	}

	public void setAlarms(List<AlarmsIndex> alarms) {
		this.alarms = alarms;
	}
	...
	public String toString() {
		return "QueryWeatherResult [alarms=" + alarms + ", aqi=" + aqi
				+ ", basic=" + basic + ", daily_forecast=" + daily_forecast
				+ ", hourly_forecast=" + hourly_forecast + ", now=" + now
